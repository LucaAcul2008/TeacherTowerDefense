...
public enum SchuelerTyp {
    ...
    TYP4("Viertklässler",   4, 48, 100, Color.YELLOW,               TYP3,  1, 12,  2),
    TYP5("Fünftklässler",   5, 60,  70, Color.ORANGE,               TYP4,  2, 20,  3),
    TYP6("Sechstklässler",  6, 60,  70, Color.PURPLE,               TYP5,  2, 30,  4),
    TYP7("Maturant",        8, 72,  50, Color.DARKGRAY,             TYP5,  4, 50,  6),
    TYP8("Schulleiter",    12, 72,  50, Color.color(0.1,0.1,0.1),   TYP7,  2, 100, 10);
